...
const showPage = ( pageNumber, studentItems ) => {
...
function appendPageLinks (studentItems) {
...
// The 'active' class name is transfered to the event target and showPage() is run.
